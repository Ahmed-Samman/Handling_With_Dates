...
int main()
{
	...
	// Diff between Dates
	int DiffInDay = GetDifferenceInDays(Date1, Date2);

	cout << "\n\nDiffrence is: " << DiffInDay << " Day(s).\n";


	DiffInDay = GetDifferenceInDays(Date1, Date2, true);

	cout << "Diffrence (Including End Day) is: " << DiffInDay << " Day(s).\n";
